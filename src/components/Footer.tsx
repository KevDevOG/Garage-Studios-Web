...
export default function Footer() {
  return (
    <footer className="border-t border-card-border bg-card-bg">
      ...
      {/* Copyright y Legal */}
      <div className="border-t border-card-border px-4 py-6 text-center text-xs text-muted flex flex-col items-center justify-center gap-4">
        ...
        <div className="text-[10px] text-muted/65 mt-1">
          Web desarrollada por{" "}
          <a
            href="https://iamkevdev.es"
            target="_blank"
